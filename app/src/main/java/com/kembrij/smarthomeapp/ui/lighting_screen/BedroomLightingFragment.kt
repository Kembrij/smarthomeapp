...
import com.kembrij.smarthomeapp.databinding.FragmentLightingBedroomBinding
import com.kembrij.smarthomeapp.databinding.FragmentLightingKitchenBinding
import dagger.hilt.android.AndroidEntryPoint


@AndroidEntryPoint
class BedroomLightingFragment : Fragment() {
    private val viewModel: LightingViewModel by viewModels()
    private lateinit var binding: FragmentLightingBedroomBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLightingBedroomBinding.inflate(inflater, container, false)
        return binding.root
    }
