...
@AndroidEntryPoint
class BathroomLightingFragment : Fragment() {

    private val viewModel: LightingViewModel by viewModels()
    private lateinit var binding: FragmentLightingBathroomBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLightingBathroomBinding.inflate(inflater, container, false)
        return binding.root
    }
